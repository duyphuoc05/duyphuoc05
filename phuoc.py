...
# Danh sách game mẫu
games = [
    {"id": 1, "name": "Cyber Odyssey", "price": 599000, "genre": "Action RPG", "image": "https://via.placeholder.com/200x200.png?text=Cyber+Odyssey", "description": "Game nhập vai hành động với đồ họa đỉnh cao."},
